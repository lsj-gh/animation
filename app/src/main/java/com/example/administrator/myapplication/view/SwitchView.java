...
public class SwitchView extends View {
    private final float RATIO_ASPECT = 0.68f;//高低比例
    private final float ANIMATION_SPEED = 0.06f;//速率
...
//    private RadialGradient shadowGradient;
    ...
    private int sv_footColor;
    private int sv_faceRoundColor;
    private int sv_faceCircularColor;
    private int sv_faceColor;
    ...
    private float sv_faceCircularSize;
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        sv_footColor = a.getColor(R.styleable.SwitchView_sv_footColor, 0xFF4BD763);
        sv_faceRoundColor = a.getColor(R.styleable.SwitchView_sv_faceRoundColor, 0xFF3AC652);
        sv_faceCircularColor = a.getColor(R.styleable.SwitchView_sv_faceCircularColor, 0xffffffff);
        sv_faceColor = a.getColor(R.styleable.SwitchView_sv_faceColor, 0xffededed);
        sv_faceCircularSize =a.getFloat(R.styleable.SwitchView_sv_faceCircularSize,0.85f);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (isCanVisibleDrawing) {
            ...
            bWidth = sBottom ;
            bRight = sLeft + bWidth;
            final float halfHeightOfS = bWidth / 2;
            //上面背景的尺寸
            bRadius = halfHeightOfS ;
            bOffset = bRadius * 0.2f;
            //圆的边框尺寸
            bStrokeWidth = (halfHeightOfS - halfHeightOfS*0.95f) * 2;
...
//        paint.setColor(isOn ? sv_footColor : 0xffE3E3E3);
        paint.setColor(sv_footColor);
...
//        paint.setColor(0xffededed);
        ...
        // 画圆按钮和边框
        canvas.scale(sv_faceCircularSize, sv_faceCircularSize, bWidth / 2, bWidth / 2);
        paint.setStyle(Paint.Style.FILL);
//        paint.setColor(0xffffffff);
        paint.setColor(sv_faceCircularColor);
        canvas.drawPath(bPath, paint);
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(bStrokeWidth * 0.5f);
        //开启状态下和关闭状态下颜色设置
        paint.setColor(isOn ? sv_faceRoundColor : 0xFFBFBFBF);
        canvas.drawPath(bPath, paint);
        canvas.restore();
