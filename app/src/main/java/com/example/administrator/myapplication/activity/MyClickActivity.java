    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv1.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            ...
            public void onComplete(RippleView rippleView) {
                Toast.makeText(MyClickActivity.this, "这是圆形外部展开", Toast.LENGTH_SHORT).show();
            }
        });
        rv2.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            @Override
            public void onComplete(RippleView rippleView) {
                Toast.makeText(MyClickActivity.this, "这是内部展开", Toast.LENGTH_SHORT).show();
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(MyClickActivity.this, "这是Listview第" + i + "个item", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
